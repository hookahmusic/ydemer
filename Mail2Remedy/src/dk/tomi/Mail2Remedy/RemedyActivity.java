...
public class RemedyActivity extends Activity{
	...
	//	public void default_group_func (){
	 // 		  SharedPreferences iconto = PreferenceManager
	//	          .getDefaultSharedPreferences(getBaseContext());  
	 // 		my_remedy_group = iconto.getString("remedy_group", "Default");
	 // 		String remedy_groupdede = "NYSS";
	//        gui_besked(my_remedy_group);
	     //   gui_besked(remedy_groupdede);
	 //   	if (my_remedy_group == remedy_groupdede){
	//    		default_cat = 3;
	//    		default_type = 2;
	//    		default_item = 1;
	 //   		}
